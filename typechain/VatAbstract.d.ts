...
interface VatAbstractInterface extends ethers.utils.Interface {
  functions: {
...
export class VatAbstract extends Contract {
  ...
  interface: VatAbstractInterface;
  ...
  functions: {
    ...
    init(arg0: BytesLike, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    "init(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    init(arg0: BytesLike, overrides?: Overrides): Promise<BigNumber>;

    "init(bytes32)"(arg0: BytesLike, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    init(arg0: BytesLike, overrides?: Overrides): Promise<PopulatedTransaction>;
